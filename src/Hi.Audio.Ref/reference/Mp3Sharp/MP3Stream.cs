...
namespace MP3Sharp {
    ...
    public class MP3Stream : Stream {
        ...
        public MP3Stream(Stream sourceStream, int chunkSize, AudioFormat audioFormat)
        {
            IsEOF = false;
            _SourceStream = sourceStream;
            _BitStream = new Bitstream(new PushbackStream(_SourceStream, chunkSize));
            ...
            var header = GetHeader(audioFormat);
            _ChannelCountRep = (short)audioFormat.Channels;
        ...
        public static Header GetHeader(AudioFormat audioFormat)
        {
            var header = new Header(audioFormat);
            return header;
        }
