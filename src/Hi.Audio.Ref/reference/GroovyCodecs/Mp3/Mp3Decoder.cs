...
using Hi.Audio.Ref.GroovyCodecs.Mp3.Mp3;
using Hi.Audio.Ref.GroovyCodecs.Mp3.Mpg;
using Hi.Audio.Ref.GroovyCodecs.Types;
...
namespace Hi.Audio.Ref.GroovyCodecs.Mp3
{
    ...
    public class Mp3Decoder : IMp3Decoder
    {
        ...
        public Mp3Decoder(Stream stream, AudioFormat audioFormat)
        {
            AudioFormat = audioFormat;
            // encoder modules
            lame = new Lame();
            ...
            //gfp.num_channels = parse.mp3input_data.stereo = AudioFormat.Channels;
            //gfp.in_samplerate = parse.mp3input_data.samplerate = AudioFormat.SampleRate;
            //gfp.num_samples = parse.mp3input_data.nsamp = AudioFormat.BitsPerSample;
            //parse.mp3input_data.framesize = audioFormat.ChunkLength;
            //gaud.not_file = true;
            gaud.init_inStream(gfp, stream, enc);
